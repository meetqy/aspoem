  ...
  return (
    <div className="relative z-10 flex bg-background/20 p-0">
      ...
      <div className="flex-1 bg-gradient-to-t from-background to-muted/10">
        <header
          className="sticky top-0 z-40 flex min-h-16 w-full flex-row-reverse items-center justify-between border-b border-border/40 bg-muted/50 pl-14 pr-4 backdrop-blur lg:pl-0"
          id="header_main"
        >
