        ...
        {data?.map((item) => (
          ...
          >
            ...
            <div className="flex items-center">
              <div className="text-outline flex h-36 w-36 flex-shrink-0 items-center justify-center overflow-hidden rounded-full bg-gradient-to-tl from-muted to-muted/20 text-8xl uppercase group-hover:bg-background">
                <span className="-mt-2 opacity-30">{item.name[0]}</span>
              </div>
