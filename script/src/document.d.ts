...
export interface paths {
    ...
    "/authors/{id}/localizations": {
        ...
        get?: never;
        put?: never;
        post: operations["post/authors/{id}/localizations"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/dynasties": {
        ...
        get: operations["get/dynasties"];
        put?: never;
        post: operations["post/dynasties"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/dynasties/{id}": {
        ...
        get: operations["get/dynasties/{id}"];
        put: operations["put/dynasties/{id}"];
        post?: never;
        delete: operations["delete/dynasties/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    schemas: {
        ...
        AuthorLocalizationRequest: {
            name: string;
            name_py?: string;
            poems?: (number | string)[];
            /** @example string or id */
            dynasty?: number | string;
            locale: string;
        };
        AuthorRequest: {
            data: {
        ...
        AuthorResponseDataObjectLocalized: {
            id?: number;
            attributes?: components["schemas"]["Author"];
        };
        AuthorLocalizationResponse: {
            data?: components["schemas"]["AuthorResponseDataObjectLocalized"];
            meta?: Record<string, never>;
        };
        AuthorListResponseDataItemLocalized: {
            id?: number;
            attributes?: components["schemas"]["Author"];
        };
        AuthorLocalizationListResponse: {
            data?: components["schemas"]["AuthorListResponseDataItemLocalized"][];
            meta?: {
                pagination?: {
                    page?: number;
                    pageSize?: number;
        ...
        DynastyListResponseDataItem: {
            id?: number;
            attributes?: components["schemas"]["Dynasty"];
        };
        DynastyListResponse: {
            data?: components["schemas"]["DynastyListResponseDataItem"][];
            meta?: {
                pagination?: {
                    page?: number;
                    pageSize?: number;
        ...
        DynastyResponseDataObject: {
            id?: number;
            attributes?: components["schemas"]["Dynasty"];
        };
        DynastyResponse: {
            data?: components["schemas"]["DynastyResponseDataObject"];
            meta?: Record<string, never>;
        };
...
export interface operations {
    ...
    "post/authors/{id}/localizations": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AuthorLocalizationRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AuthorLocalizationResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    "get/dynasties": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DynastyListResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    "post/dynasties": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["DynastyRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DynastyResponse"];
                };
            };
            /** @description Bad Request */
            400: {
